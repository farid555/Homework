  ...
  public class IOU
  {
    ...
    public IOU()
    {
      this.dictionary = new Dictionary<string, int>();
        ...
        // saves the amount owed and the person owed to the IOU. it can use this to also the debt, but the total amount cannot negative! 
      ...
      if (this.dictionary.ContainsKey(toWhom))
    {
     ...
     // returns the amount owed to the person whose name is given as a parameter. ifthe person cannot be found, it returns 0.
